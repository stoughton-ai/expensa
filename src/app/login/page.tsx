    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: '20px',
          padding: '3rem 2.5rem',
          boxShadow: '0 8px 40px rgba(0,0,0,0.3), 0 0 80px rgba(99,102,241,0.06)',
        }}>
          {/* Logo */}
          <div style={{
            display: 'flex',
          ...
          <p style={{
            ...
            Sign in with your Google account to access your receipts and expenses.
          </p>
          ...
          {error && (
            <div style={{
              ...
              {error === 'AccessDenied'
                ? '⛔ Access denied. This app is restricted to authorised accounts only.'
